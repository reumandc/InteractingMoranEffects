...
different assumption. If, as in Fig. \ref{fig:PedagogAlt}a, b, $l_n+l_{e1}=l_{e2}$ (or $l_n+l_{e1}-l_{e2}$ is any integer
...
shows the opposite scenario, for which $l_n+l_{e1}=l_{e2}-\sigma/2$. Thus
...
(The same outcome would occur if $l_n+l_{e1}-l_{e2}$ were any integer multiple of $\sigma$ plus or minus $\sigma/2$.)
Intermediate scenarios between the two scenarios of Fig. \ref{fig:PedagogAlt} are also possible, as will be revealed by 
the theory. If we replace the assumption that
...
Thus $l_{e1}-l_{e2}+l_n=2 \text{q}=0.5 \text{y}$, and, on annual timescales, lags compounded, similar to 
...
positive population influences (as in Fig. \ref{fig:PedagogAlt}), 
but that larger values of $\epsilon_i^{(2)}$ have more negative population influences (contrasting
with Fig. \ref{fig:PedagogAlt}). In scenario $\beta 1$, 
