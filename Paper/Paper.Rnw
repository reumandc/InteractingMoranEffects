...
Thus interactions between Moran effects provide yet another reason, among reasons our previous work
has already documented (e.g., \citealp{Sheppard2016,Walter2017,Anderson2021,Zhao2020}), that patterns 
of synchrony mush be considered from a timescale-specific 
viewpoint to achieve fuller understanding. 
