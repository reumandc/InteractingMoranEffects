...
% \section{Detailed breakdown of terms in the general theory for the case studies}\label{sect:breakdown_case_studies}
% 
% We here provide a detailed technical breakdown how the terms in our main theoretical equation, 
% (\ref{MT-rhoww_T1to3}), capture the complexities of CaseA described in the main text.
% The size of the $1$q lag of the effects of 
% 
% 
...
% 
% 
% \section{Detailed breakdown of terms in the general theory for kelp}\label{sect:breakdown_kelp}
