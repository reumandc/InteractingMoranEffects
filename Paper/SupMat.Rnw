...
\section{Details of statistical methods}
...
for the first central CA region (a-c) and the southern CA region (d-f), but also results from the 
second central CA region (g-i).}\label{fig:SummaryKelpFig_SM_lag4}
\end{figure}
...
for the first central CA region (a-o) and the southern CA region (p-dd), but also results from the 
second central CA region (ee-ss).}\label{fig:directMoran_SM_lag4}
\end{figure}
...
for the first central CA region (a-o) and the southern CA region (p-dd), but also results from the 
second central CA region (ee-ss).}\label{fig:indirectMoran_SM_lag4}
\end{figure}
