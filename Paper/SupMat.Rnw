...
\section{Details of data and data cleaning}\label{sect:data}
...
\caption[All theory constituents for kelp for direct Moran effects terms, kelp lags up to 4 quarters]{Plots of all constituents of 
...
\caption[All theory constituents for kelp for Moran interaction terms, kelp lags up to 4 quarters]{Plots of 
...
\begin{table}[!h]
\caption{Regression coefficients used to parameterize (\ref{MT-main_model_1})-(\ref{MT-main_model_4}) of the main text for each 
