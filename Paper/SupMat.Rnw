...
\title{Supporting information for ``Environmental drivers of synchrony and their interactions''}
\date{}
...
\caption[Extension of main text Fig. \ref{MT-fig:SummaryKelpFig}]{Same format as Fig. \ref{MT-fig:SummaryKelpFig} of the main text, but including not only results
...
\caption[Extension of main text Fig. \ref{MT-fig:directMoran}]{Same format as Fig. \ref{MT-fig:directMoran} of the main text, but including not only results
for the CCA1 region (a-o) and the SB region (p-dd), but also results from the 
CCA2 region (ee-ss).}\label{fig:directMoran_SM_lag4}
\end{figure}
...
\caption[Like Fig. \ref{fig:directMoran_SM_lag4} but with kelp lag effects up to 8 quarters]{Same format as Fig. \ref{fig:directMoran_SM_lag4}, but based on a model that considered 
potential kelp lag effects from up to 8 quarters in the past (see Methods). Results were substantively
...
\caption[Like Fig. \ref{fig:directMoran_SM_lag4} but with kelp lag effects up to 12 quarters]{Same format as Fig. \ref{fig:directMoran_SM_lag4}, but based on a model that considered 
potential kelp lag effects from up to 12 quarters in the past (see Methods). Results were substantively
...
\caption[Extension of main text Fig. \ref{MT-fig:indirectMoran}]{Same format as Fig. \ref{MT-fig:indirectMoran} of the main text, but including not only results
for the CCA1 region (a-o) and the SB region (p-dd), but also results from the 
CCA2 region (ee-ss).}\label{fig:indirectMoran_SM_lag4}
\end{figure}
